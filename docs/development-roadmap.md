...
- [x] Import/export portable calibration values as either staged targets or a command-free current-TV draft; provide confirmed reset-to-defaults and reset/reapply workflows; and make long Apply/reset batches cancellable at the remote-key boundary.
