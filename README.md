...
Expert calibration controls stay near the top of the page under dedicated **2pt white balance**, **20pt white balance**, and **Color** tabs. The compact **Update behavior** panel is collapsed by default, and the permanent Picture, Sound, and other top-level menu tabs remain below Expert Settings rather than being hidden with those options.
